    ...
    <div>
      ...
      <svg id="svgCanvas" viewBox="0 0 2000 1000" preserveAspectRatio="xMinYMin slice" width="100%"  >
        ...
        <g transform="translate(150, 150)">
          <circle className='shooting-star' fill='white' cx="0" cy="0" r="2" radius="125" ></circle>
        </g>
      </svg>
      ...
      <div className='page-body'>
          ...
          <div className='big-font'>
            Daniel Alejandro Castillo Oropeza
          </div>

          <div className='small-font'>
            I am a sofware engineer with a passion for designing beautiful web-apps and efficient backends
          </div>
      </div>
    </div>
  )
